...
class Credential(CreateUpdateModelBase):
    ...
    name = models.CharField(
        verbose_name=_("name"), blank=True, null=True, max_length=80
    )
    ...
    client_url = models.CharField(
        verbose_name=_("Client URL"), blank=True, null=True, max_length=200
    )
    public_key = EncryptedTextField(null=True, blank=True, verbose_name=_("Public Key"))
    private_key = EncryptedTextField(
        null=True, blank=True, verbose_name=_("Private Key")
    )
